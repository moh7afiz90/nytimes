  ...
  return (
    ...
    <Card className={cx(styles.root, shadowStyles.root)}>
      <CardMedia
        ...
        image={props.singleStory.multimedia[1].url}
      />
      <CardContent>
        <TextInfoCardContent
          classes={styles}
          overline={moment(props.singleStory.created_date).format('lll')}
        />
        <Typography className={styles.overline} variant={'overline'}>
          <strong>{props.singleStory.byline}</strong>
        </Typography>
        <br></br>
        <Typography className={styles.title}>
          <strong>{props.singleStory.title}</strong>
        </Typography>
        <br />
        <Typography className={styles.body}>
          <strong>{props.singleStory.abstract}</strong>
        </Typography>
        <br />
        <Chips singleStory={props.singleStory}/>
        <br></br>
        <hr />
        <Button href={props.singleStory.url} variant={'contained'} color={'primary'}>
          View Aritcle
        </Button>
      </CardContent>
    </Card>
